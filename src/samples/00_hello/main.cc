...
class SampleApp final : public Application {
 ...
 private:
  ...
  void frame() final {
    ...
    /* Optionnal, change the default Render Target clear color value. */
    ...
    auto pass = cmd.begin_rendering(/*renderer_*/);
    {
      /*
        ...
        With no argument specified to 'begin_rendering' (either a RTInterface or
    ...
    /* Alternative with more direct controls. */
