#ifndef VKPLAYGROUND_FRAMEWORK_FX_POST_FX_PIPELINE_H_
#define VKPLAYGROUND_FRAMEWORK_FX_POST_FX_PIPELINE_H_
...
#endif // VKPLAYGROUND_FRAMEWORK_FX_POST_FX_PIPELINE_H_