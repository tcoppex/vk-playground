#ifndef VKPLAYGROUND_FRAMEWORK_RENDERER_POST_FX_COMPUTE_H
#define VKPLAYGROUND_FRAMEWORK_RENDERER_POST_FX_COMPUTE_H

#include "framework/fx/postprocess/generic_fx.h"
...
#endif // VKPLAYGROUND_FRAMEWORK_RENDERER_POST_FX_COMPUTE_H
