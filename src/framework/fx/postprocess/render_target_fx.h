#ifndef VKPLAYGROUND_FRAMEWORK_RENDERER_POST_FX_RENDER_TARGET_H
#define VKPLAYGROUND_FRAMEWORK_RENDERER_POST_FX_RENDER_TARGET_H

#include "framework/fx/postprocess/fragment_fx.h"
...
#endif // VKPLAYGROUND_FRAMEWORK_RENDERER_POST_FX_RENDER_TARGET_H
