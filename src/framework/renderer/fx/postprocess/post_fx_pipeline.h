#ifndef VKFRAMEWORK_RENDERER_FX_POSTPROCESS_POST_FX_PIPELINE_H_
#define VKFRAMEWORK_RENDERER_FX_POSTPROCESS_POST_FX_PIPELINE_H_
...
#endif // VKFRAMEWORK_RENDERER_FX_POSTPROCESS_POST_FX_PIPELINE_H_