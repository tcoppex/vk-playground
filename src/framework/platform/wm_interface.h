#ifndef VKPLAYGROUND_FRAMEWORK_PLATEFORM_WM_INTERFACE_H
#define VKPLAYGROUND_FRAMEWORK_PLATEFORM_WM_INTERFACE_H
...
#endif  // VKPLAYGROUND_FRAMEWORK_PLATEFORM_WM_INTERFACE_H
