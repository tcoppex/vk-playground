#ifndef VKPLAYGROUND_FRAMEWORK_PLATEFORM_EVENT_CALLBACKS_H
#define VKPLAYGROUND_FRAMEWORK_PLATEFORM_EVENT_CALLBACKS_H
...
#endif  // VKPLAYGROUND_FRAMEWORK_PLATEFORM_EVENT_CALLBACKS_H
